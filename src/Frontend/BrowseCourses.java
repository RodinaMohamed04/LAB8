...
public class BrowseCourses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Course Id", "Course Name", "Availability", "Action"
            }
        ));
...
private void loadCourses() {
        ...
        model.setColumnIdentifiers(new String[]{"Course Id", "Course Name", "Availability", "Action"});
         ...
         for(int i=0;i<c.size();i++){
             Course c2=c.get(i);
         model.addRow(new Object []{c2.getCourseId(),c2.getCourseName(),"Available","Enroll"});
         }
