 ...
 * @author mo
 */
public class ViewStudentsInCourse extends javax.swing.JFrame {

    private Instructor instructor;
    private CourseService courseService = new CourseService();
    String courseId;
    public ViewStudentsInCourse(Instructor instructor, String courseId) {
  ...
  /*private void loadStudentsInCourse() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student in course");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "Student Id", "Student Name", "Progress"
                }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        InstructorDashBoard id = new InstructorDashBoard(instructor);
        id.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudentsInCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                java.awt.EventQueue.invokeLater(() -> new ViewStudentsInCourse().setVisible(true));
